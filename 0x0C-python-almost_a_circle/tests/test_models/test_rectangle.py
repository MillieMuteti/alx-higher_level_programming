...
OAOA        r = Rectangle(10, 10, 10, 10, 10)
OA        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
OA            r.update(89, 1, 2, 3, -6)
OA
OA    def test_update_args_width_before_height(self):
OA        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
